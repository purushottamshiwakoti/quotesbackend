...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Category: Attribute.Enumeration<['Quotes', 'Shayari', 'Wishes']> &
      Attribute.Required &
      Attribute.DefaultTo<'Quotes'>;
    SEO: Attribute.Component<'shared.seo'>;
    view: Attribute.BigInteger & Attribute.DefaultTo<'10'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTermsandConditionTermsandCondition
  ...
  collectionName: 'termsand_conditions';
  info: {
    singularName: 'termsand-condition';
    pluralName: 'termsand-conditions';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::termsand-condition.termsand-condition',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::termsand-condition.termsand-condition': ApiTermsandConditionTermsandCondition;
    }
  }
}
